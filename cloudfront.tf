...
resource "aws_cloudfront_distribution" "cf" {
  ...
  origin {
    ...
    s3_origin_config {
      origin_access_identity = aws_cloudfront_origin_access_identity.cd_s3_origin_access_identity.cloudfront_access_identity_path
    }
  }
...
resource "aws_cloudfront_origin_access_identity" "cd_s3_origin_access_identity" {
